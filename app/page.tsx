  ...
  return (
    <>
      <div id="projects" className="min-h-screen mainPage">
        <Encabezado />        
        <div className="flex flex-col items-center justify-center pt-40 max-sm:pt-28 ">
          <h1 className="text-black text-5xl font-extrabold max-sm:text-3xl ">Punto y Tejido </h1>
